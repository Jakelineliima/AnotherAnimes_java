...
<jsp:include page="layouttopo.jsp"></jsp:include>
        ...
        <h1 class="txt-light font-weight-bold">Já pensou em um lugar<br> para salvar seus episódios?</h1>
        <p style="padding:34px">Crie sua conta agora e aproveite!</p>
        <a href="/conta" style="border-radius: 22px;  font-family: 'Staatliches', cursive;" type="button"
    ...
    <div class="recurso container">
        <div class="card" style="width: 18rem;">
            <img class="cardimg text-center" src="/imagens/icones/save.svg" alt="salve seus episódios">
        ...
        <div class="card card2" style="width: 18rem;">
            <img class="cardimg text-center" src="/imagens/icones/smartphone.svg" alt="Disponivel para android">
            <div class="card-body text-center">
        ...
        <div class="card" style="width: 18rem;">
            <img class="cardimg text-center" src="/imagens/icones/livre.svg" alt="salve seus episódios">
            <div class="card-body text-center">
