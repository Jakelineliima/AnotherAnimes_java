		...
		<div class="enter">
			...
			<div class="tmp">
				<input class="temp" type="text" placeholder="Temporada"
					name="temporada"> <input class="ep" type="number"
					placeholder="Episódio" name="episodio">
			</div>
		</div>
		<div class="teste">
			<button style="border-radius: 22px;" type="submit" class="btn borda"
				value="upload">Salvar</button>
		</div>
	</form>
</div>
