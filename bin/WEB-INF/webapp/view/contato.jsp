...
<jsp:include page="layouttopo.jsp"></jsp:include>
        ...
        <div class="formcont">
            ...
            <div class="form">
                <div class="form-group">
                    <input class="form-control" id="" placeholder="Nome:" name="nome" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                        placeholder="Escreva aqui sua mensagem:" name="mensagem" required></textarea>
                </div>
                </div>
            </div>
    ...
    <div class="container cont">
        ...
        <div class="social">
            <div class="textsoc">
                <a href="#"><img src="/imagens/icones/facebook.svg" alt="logo facebook"></a>
                <p>AnotherAnimes</p>
            </div>
            <div class="textsoc">
                <a href="#"><img src="/imagens/icones/001-instagram.svg" alt="logo instagram"></a>
                <p>@AnotherAnimes</p>
            </div>
            <div class="textsoc">
                <a href="#"><img src="/imagens/icones/002-twitter.svg" alt="logo twitter"></a>
                <p>@AnotherAnimes</p>
            </div>
        </div>
    </div>
